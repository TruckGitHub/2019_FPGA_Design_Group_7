...
//               d:/FPGA/Lab02/Lab02.srcs/sources_1/bd/design_1/ip/design_1_RGB_LED_0_0/design_1_RGB_LED_0_0_stub.v
...
module design_1_RGB_LED_0_0(clk, rst, R_time_in, G_time_in, B_time_in, R_out, 
  G_out, B_out, cur_st)
/* synthesis syn_black_box black_box_pad_pin="clk,rst,R_time_in[7:0],G_time_in[7:0],B_time_in[7:0],R_out,G_out,B_out,cur_st[2:0]" */;
  input clk;
  input rst;
  input [7:0]R_time_in;
  input [7:0]G_time_in;
