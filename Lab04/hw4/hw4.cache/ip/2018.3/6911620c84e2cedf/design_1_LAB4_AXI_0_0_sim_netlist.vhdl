...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_arithmetic is
  port (
    ...
    \axi_rdata_reg[31]_3\ : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_arithmetic is
  ...
  attribute SOFT_HLUTNM of \i___0_carry_i_8\ : label is "soft_lutpair4";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_sorting is
  ...
  signal \bit_array_reg[7]_i_4_n_0\ : STD_LOGIC;
  ...
  signal \insert[7][3]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[0]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[1]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[2]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[3]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[4]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[5]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[6]\ : label is "LD";
  attribute XILINX_LEGACY_PRIM of \bit_array_reg[7]\ : label is "LD";
...
\bit_array_reg[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \^insert_reg[0][3]_0\(15),
      I3 => data_in(2),
      I4 => \^insert_reg[0][3]_0\(16),
      I5 => data_in(3),
...
\bit_array_reg[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8808AAAA00008808"
        ...
        port map (
      I0 => s00_axi_aresetn,
      I1 => \bit_array_reg[1]_i_2_n_0\,
      I2 => \^insert_reg[0][3]_0\(11),
      I3 => data_in(2),
      I4 => \^insert_reg[0][3]_0\(12),
      I5 => data_in(3),
...
\bit_array_reg[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8808AAAA00008808"
        ...
        port map (
      I0 => s00_axi_aresetn,
      I1 => \bit_array_reg[2]_i_2_n_0\,
      I2 => \^insert_reg[0][3]_0\(7),
      I3 => data_in(2),
      I4 => \^insert_reg[0][3]_0\(8),
      I5 => data_in(3),
...
\bit_array_reg[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"20F220F2FFFF20F2"
    )
        port map (
...
\bit_array_reg[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8808AAAA00008808"
        ...
        port map (
      I0 => s00_axi_aresetn,
      I1 => \bit_array_reg[4]_i_2_n_0\,
      I2 => answer_1(14),
      I3 => data_in(2),
      I4 => \^insert_reg[0][3]_0\(0),
      I5 => data_in(3),
...
\bit_array_reg[7]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\insert[6][3]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
...
\insert[6][3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BA8A"
    )
        port map (
...
\insert[7][3]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\insert_reg[7][3]_i_2\: unisim.vcomponents.MUXF7
     port map (
      I0 => \insert[7][3]_i_3_n_0\,
      I1 => \insert[7][3]_i_4_n_0\,
      O => data_in(3),
      S => \count_reg__0\(2)
    );
end STRUCTURE;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_LAB4_AXI_v1_0_S00_AXI is
  ...
  signal slv_reg2_0 : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \axi_rdata[14]_i_3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \axi_rdata[14]_i_4\ : label is "soft_lutpair8";
...
ARI: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_arithmetic
     port map (
      ...
      \axi_rdata_reg[31]_3\(2 downto 0) => slv_reg3(2 downto 0),
