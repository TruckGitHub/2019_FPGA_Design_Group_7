...
HD_PWD='C:/Users/USER/Documents/FPGA/CNN_accelerator/CNN_accelerator.runs/acceleraor_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acceleraor_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acceleraor_xbar_0.tcl
