...
HD_PWD='C:/Users/USER/Documents/FPGA/CNN_accelerator/CNN_accelerator.runs/acceleraor_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acceleraor_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acceleraor_proc_sys_reset_0_0.tcl
