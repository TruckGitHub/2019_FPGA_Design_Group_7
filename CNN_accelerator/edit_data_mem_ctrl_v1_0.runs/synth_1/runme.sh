...
HD_PWD='C:/Users/USER/Documents/FPGA/ip_repo/edit_data_mem_ctrl_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_mem_ctrl_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_mem_ctrl_v1_0.tcl
